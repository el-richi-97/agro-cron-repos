...
SCRIPT_PATH="$CRONJOBS_DIR/agro_update_fecha_fin_real_estado_cerrado_actividad.py"
ENV_PATH="$PROJECT_DIR/venv"
LOG_PATH="$PROJECT_DIR/logs/agro_update_fecha_fin_real_estado_cerrado_actividad.log"

# Crear directorio de logs si no existe
mkdir -p "$(dirname "$LOG_PATH")"

# Fecha y hora de inicio en formato 'YYYY-MM-DD HH:MM' (ajusta la fecha y hora según sea necesario)
START_DATETIME="2024-08-08 07:10"
